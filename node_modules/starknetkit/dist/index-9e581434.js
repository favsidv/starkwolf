...
var j = (M, e, t) => e in M ? g(M, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : M[e] = t;
var N = (M, e, t) => (j(M, typeof e != "symbol" ? e + "" : e, t), t);
import { constants as I } from "starknet";
import { C as o, a, b as s, U as D, r, d as u } from "./lastConnected-b964dc30.js";
...
class L extends o {
  ...
  onNetworkChanged(t) {
    switch (t) {
      case "SN_MAIN":
        this.emit("change", {
          chainId: BigInt(I.StarknetChainId.SN_MAIN)
        });
        break;
      case "SN_GOERLI":
        this.emit("change", {
          chainId: BigInt(I.StarknetChainId.SN_GOERLI)
        });
        break;
      case "mainnet-alpha":
        this.emit("change", {
  ...
  async disconnect() {
    if (this.ensureWallet(), r(), !this.available())
      throw new s();
